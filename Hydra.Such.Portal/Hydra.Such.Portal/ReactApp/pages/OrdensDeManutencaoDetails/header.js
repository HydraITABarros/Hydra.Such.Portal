    ...
    render() {
        return (
            <div>
                ...
                <Grid container direction="row" justify="space-between" alignitems="top" spacing={0} maxwidth={'100%'}
                    ...
                    <Grid container item md={6} xs={12}>
                        ...
                        {this.state.isLoading ? true : this.state.executed + this.state.toExecute > 0 &&
                            <CircleOmWrapper className={this.state.isLoading ? 'blink' : ''}>
                                <CircleOm.icon
                                    background={this.state.isLoading ? this.props.theme.palette.primary.keylines : this.props.theme.palette.primary.dark}
                                    color={this.props.theme.palette.primary.keylines} fontSize="71px">
                                    <Spacer height="15px"/>
                                    <Icon sad/>
                                ...
                                <CircleOm.icon
                                    ...
                                    color={this.state.isLoading ? this.props.theme.palette.primary.keylines : this.props.theme.palette.secondary.default}
                                    fontSize="71px">
                                    <Spacer height="20px"/>
                                    <Icon happy/>
                                    <Wrapper textAlign="center">
                                        {!this.state.isLoading && <Text dataSmall
                                                                        color={this.props.theme.palette.secondary.default}>{this.state.executed}</Text>}
                                    </Wrapper>
                                </CircleOm.icon>
                            </CircleOmWrapper>
                        }
                    ...
                    <Grid item md={3} xs={12}>
                        <Hidden mdDown>
                            ...
                            <Wrapper textAlign="center" inline>
                                ...
                                {/*<Text p> Relatórios por <Button style={{padding: 0}} link
                                                                href={"javascript:void(0)"}>assinar</Button> </Text>
                                */}
