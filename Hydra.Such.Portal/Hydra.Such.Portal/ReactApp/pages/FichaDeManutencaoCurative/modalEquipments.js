...
class ModalEquipments extends Component {
	...
	render() {
		return (
			<ModalLarge action={this.props.children} children={
				<div>
					<DialogTitle>
					...
					<hr />
					<DialogActions>
						<Wrapper className="equipmentsCounter" padding="0 0 0 40px"><Text span>{this.props.$equipments && this.props.$equipments.value.length} Equipamentos</Text></Wrapper><Button primary color="primary">Guardar</Button>
					</DialogActions>
				</div>
			} />
		)
