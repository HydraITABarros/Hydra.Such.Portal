...
namespace Hydra.Such.Data.Logic
{
    public class DBNAV2017Contacts
    {
        ...
        public static List<NAVContactsViewModel> GetContactsByType(string NAVDatabaseName, string NAVCompanyName, string NAVContactNo, int type = -1)
        {
            try
            {
                List<NAVContactsViewModel> result = new List<NAVContactsViewModel>();
                using (var ctx = new SuchDBContextExtention())
                {
                    var parameters = new[]{
                        ...
                        new SqlParameter("@CompanyName", NAVCompanyName),
                        new SqlParameter("@NoContato", NAVContactNo),
                        new SqlParameter("@ContactType", type)
                    };

                    IEnumerable<dynamic> data = ctx.execStoredProcedure("exec NAV2017ContactosPorTipo @DBName, @CompanyName, @NoContato, @ContactType", parameters);
