...
{
   public class DBNAV2017NecessityDirectShopping
    {
        public static List<NAVOpenOrderLinesViewModels> GetAll(string NAVDatabaseName, string NAVCompanyName)
        {
            try
            {
                ...
                using (var ctx = new SuchDBContextExtention())
                {
                    ...
                    IEnumerable<dynamic> data = ctx.execStoredProcedure("exec NAV2017NecessidadeComprasDiretas @DBName, @CompanyName", parameters);
