        ...
        public static PedidosPagamentoViewModel ParseToViewModel(this PedidosPagamento ObjectToTransform)
        {
            if (ObjectToTransform != null)
            {
                return new PedidosPagamentoViewModel()
                {
                    ...
                    UserEditorPrioritario = ObjectToTransform.UserEditorPrioritario,
                    ...
                    CodigoRegiao = ObjectToTransform.CodigoRegiao,
                    CodigoAreaFuncional = ObjectToTransform.CodigoAreaFuncional,
                    CodigoCentroResponsabilidade = ObjectToTransform.CodigoCentroResponsabilidade,
