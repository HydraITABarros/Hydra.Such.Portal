    ...
    public static class DBProjectDiary
    {
        ...
        public static ProjectDiaryViewModel ParseToViewModel(DiárioDeProjeto x)
        {
            return new ProjectDiaryViewModel()
            {
                ...
                TotalCost = Math.Round((decimal)(Math.Round((decimal)x.Quantidade, 2) * Math.Round((decimal)x.CustoUnitário, 4)), 2),
                UnitPrice = Math.Round((decimal)x.PreçoUnitário, 4),
                TotalPrice = Math.Round((decimal)(Math.Round((decimal)x.Quantidade, 2) * Math.Round((decimal)x.PreçoUnitário, 4)), 2),
