...
namespace Hydra.Such.Data.NAV
{
    public static class WSProjectDiaryLine
    {
        ...
        public static async Task<WSCreateProjectDiaryLine.CreateMultiple_Result> CreateNavDiaryLinesWithDataRececao(List<RequisitionLineViewModel> items, Guid transactionId, NAVWSConfigurations WSConfigurations, DateTime DataRececao)
        {
            if (items == null)
                throw new ArgumentNullException("items");
