...
namespace Hydra.Such.Data.Evolution.DatabaseReference
{
    public partial class EvolutionWEBContext : DbContext
    {
        ...
        public virtual DbSet<FichaManutencaoRelatorioDocuments> FichaManutencaoRelatorioDocuments { get; set; }
        ...
        public virtual DbSet<FichaManutencaoRelatorioMaterial> FichaManutencaoRelatorioMaterial { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FichaManutencaoRelatorio>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Om, e.IdEquipamento })
                    .HasName("IX_Ficha_Manutencao_Relatorio")
                    .IsUnique();
                ...
                entity.Property(e => e.AssinaturaClienteManual).HasColumnName("Assinatura_Cliente_Manual");

                entity.Property(e => e.AssinaturaSie).HasColumnName("Assinatura_SIE");

                entity.Property(e => e.AssinaturaSieIgualCliente).HasColumnName("Assinatura_SIE_igual_Cliente");
                ...
                entity.Property(e => e.DataEstadoFinal).HasColumnType("datetime");
                ...
                entity.Property(e => e.RelatorioTrabalho)
                    .HasColumnName("Relatorio_Trabalho")
                    .HasColumnType("text");

                entity.Property(e => e.Versao).HasMaxLength(10);
            });

            modelBuilder.Entity<FichaManutencaoRelatorioDocuments>(entity =>
            {
                entity.ToTable("Ficha_Manutencao_Relatorio_Documents");
                ...
                entity.Property(e => e.FileOriginalName).IsRequired();
            ...
            modelBuilder.Entity<FichaManutencaoRelatorioMaterial>(entity =>
            {
                entity.ToTable("Ficha_Manutencao_Relatorio_Material");

                entity.Property(e => e.IdRelatorio).HasColumnName("Id_Relatorio");

                entity.Property(e => e.Quantidade).HasMaxLength(255);
            });
